<div align="center">
  ...
  <h3>
    <a href="https://lalit-the-wild-oasis-hotel.vercel.app">
      <strong>Live Site</strong>
    </a>
  </h3>

  <div align="center">
    <a href="https://lalit-the-wild-oasis-hotel.vercel.app">View website</a>
    •
    <a href="https://github.com/lj-unicorn/The-Wild-Oasis-Hotel/issues">Report Bug</a>
    •
    <a href="https://github.com/lj-unicorn/The-Wild-Oasis-Hotel/pulls">Request Feature</a>
  </div>
...
[![LinkedIn](https://img.shields.io/badge/LinkedIn-Connect-blue?style=for-the-badge&logo=linkedin)](https://www.linkedin.com/in/lalit-chaudhary-9j)
...
<!-- Screenshot -->
<a align="center" href="https://lalit-the-wild-oasis-hotel.vercel.app">
...
Check out the live admin app here: [The Wild Oasis - Admin](hhttps://lalit-the-wild-oasis-hotel.vercel.app)

## Customer Version

I also built a **customer version** of this app, where guests can view and book cabins, manage their bookings, and update their profiles. The repository is [here](https://github.com/lj-unicorn/The-Wild-Oasis-Customer), and the live site is [here](https://lalit-the-wild-oasis-customer.vercel.app).
...
1. Clone the repo:
   ```bash
   git clone https://github.com/lj-unicorn/The-Wild-Oasis-Hotel.git
   ```
...
4. Run the development server:
   ...
   npm run dev
   ```
5. Open [http://localhost:5174](http://localhost:5174) to see the app.

## Author

<b>👤 Lalit </b>

- LinkedIn - [@lalit-chaudhary-9j](https://www.linkedin.com/in/lalit-chaudhary-9j)
- GitHub - [@lj-unicorn](https://github.com/lj-unicorn)
